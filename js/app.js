...
(function () {
  ...
  function bindEvents() {
    ...
    $('#homeBuildingFilter').addEventListener('change', renderRoomList);
    $('#filterWebex').addEventListener('change', renderRoomList);
    $('#filterProjector').addEventListener('change', renderRoomList);

    $('#viewMode').addEventListener('change', renderSchedule);
    $('#scheduleDate').addEventListener('change', renderSchedule);
    $('#scheduleBuilding').addEventListener('change', renderSchedule);
    ...
    $('#bookBuilding').addEventListener('change', updateBookRoomOptions);
    ['#bookStartDate', '#bookEndDate', '#bookStartSlot', '#bookEndSlot'].forEach(sel => {
      $(sel).addEventListener('change', updateBookPreview);
    });
    ...
    $('#downloadTemplateBtn').addEventListener('click', getImportTemplateCSV);
